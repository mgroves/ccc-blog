...
:slug: Swashbuckle-Swagger-ASPNET-Core
...
_The full source code used in this example is available on Github._
...
image:00103-swagger-ui.png[Swagger UI]
...
* link:https://github.com/domaindrivendev/Swashbuckle[Swashbuckle for ASP.NET]
